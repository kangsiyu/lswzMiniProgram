Component({
  ...
  methods: {
    ...
    selectDistrictRight: function(e) {
      var selectedTitle = e.target.dataset.model.titleResult;
      var zhanli =  e.target.dataset.model.zhanli;
      var mutou = e.target.dataset.model.mutou;
      var liangshi =  e.target.dataset.model.liangshi;
      var tie =  e.target.dataset.model.tie;
      var baoshi =  e.target.dataset.model.baoshi;
      this.closeHyFilter();
      this.setData({
    ...
    selectSourceItem: function(e) {
      ...
      const newLocal = e.target.dataset.model.id
      var selectedId = newLocal
      var selectedTitle = e.target.dataset.model.titleResult;
      this.closeHyFilter();
      this.setData({
